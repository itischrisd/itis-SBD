...
EXECUTE LISTA_NAPRAW_DLA_POJAZDU '15GCD0911K1031583'
GO
EXECUTE LISTA_NAPRAW_DLA_POJAZDU 'aaa'
GO
...
EXECUTE WPROWADZ_KLIENTA 'Adas', 'Niezgodka', 'Akademia Pana Kleksa',
        1234567890, 700600500, 'adas@akademia.pl',
        'Kwiatowa', 5, 23,
        '02-123',
        'Pacanowo', 'Szczeboszyce';
GO
...
EXECUTE WPROWADZ_KLIENTA 'Hans', 'Kloss', DEFAULT,
        DEFAULT, 700600500, DEFAULT,
        'Polonische Strasse', 5, DEFAULT,
        '02-137',
        'Pacanowo', DEFAULT;
GO
...
VALUES (1609, '1G6DP1E38C0114115', 217, 124, 10000, NULL, CONVERT(DATETIME, '31-DEC-2022'), 3);
...
SELECT P1.OsobaId, P1.Pensja, P1.PrzelozonyId, P2.Pensja
FROM Pracownik P1
         INNER JOIN Pracownik P2 ON P1.PrzelozonyId = P2.OsobaId;
